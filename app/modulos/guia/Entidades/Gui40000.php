...
class Gui40000 extends \EntidadBase {
	...
	public function __construct($adapter,$param=array(),$bd='') {
            ...
            {
                $this->table=$param['param1'].'.gui40000';
            }
            else if (strlen($bd)>0)
            {
                $this->table=$bd.'.gui40000';
            }
            else
            {
        ...
        function setSecuencial($secuencial) {
	...
	public function save()
        {
		$query="INSERT INTO $this->table (id,bodega,direccion,secuencial,activo)
			VALUES(NULL,
			'".$this->bodega."',
                        '".$this->direccion."',
			'".$this->secuencial."',
