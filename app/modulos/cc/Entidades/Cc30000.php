...
class Cc30000 extends \EntidadBase {
	...
	public function __construct($adapter,$param=array(),$bd='') {
            ...
            {
                $this->table=$param['param1'].'.cc30000';
            }
            else if (strlen($bd)>0)
            {
                $this->table=$bd.'.cc10000';
            }
            else
            {
        ...
        function setMonto_abonado($Monto_abonado) {
	...
	public function save()
        {
		$query="INSERT INTO $this->table (id,documento,pedido,cc00000id,cc00002id,fecha,subtotal,descuento,iva,total,usuario)
			VALUES(NULL,
			'".$this->documento."',
                        '".$this->pedido."',
                        '".$this->cc00000id."',
