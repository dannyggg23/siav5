...
class Cc11010 extends \EntidadBase {
	...
	public function __construct($adapter,$param=array(),$bd='') {
            ...
            {
                $this->table=$param['param1'].'.cc11010';
            }
            else if (strlen($bd)>0)
            {
                $this->table=$bd.'.cc11010';
            }
            else
            {
        ...
        function getCc11000id() {
            return $this->cc11000id;
        }
        ...
        function setCc11000id($cc11000id) {
            $this->cc11000id = $cc11000id;
        }
	...
	public function save()
        {
		$query="INSERT INTO $this->table (id,cc11000id,inv00000codigo,descripcion,costo,bodega,cantidad,precio,descuento,subtotal,guia,cantidad_guia,marca_producto,stock_producto,descuento_cliente)
			VALUES(NULL,
			'".$this->cc11000id."',
                        '".$this->inv00000codigo."',
                        '".$this->descripcion."',
