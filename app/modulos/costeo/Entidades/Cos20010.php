...
class Cos20010 extends \EntidadBase {
	...
	public function __construct($adapter,$param=array(),$bd='') {
            ...
            {
                $this->table=$param['param1'].'.cos20010';
            }
            else if (strlen($bd)>0)
            {
                $this->table=$bd.'.cos20010';
            }
            else
            {
                $this->table=isset($_SESSION['bdcliente'])?$_SESSION['bdcliente'].'.cos20010':'cos20010';
            }
	...
	public function save() {
            $query = "INSERT INTO $this->table(id,documento,documento_orden,inv00000id,tasa,cantidad,activo)
                            VALUES(NULL,
                            '".$this->documento."',
