...
class Cos20200 extends \EntidadBase {
	...
	public function __construct($adapter,$param=array(),$bd='') {
            ...
            {
                $this->table=$param['param1'].'.cos20200';
            }
            else if (strlen($bd)>0)
            {
                $this->table=$bd.'.cos20200';
            }
            else
            {
                $this->table=isset($_SESSION['bdcliente'])?$_SESSION['bdcliente'].'.cos20200':'cos20200';
            }
        ...
        function getCos10000id() {
            return $this->cos10000id;
        }
        ...
        function setCos10000id($cos10000id) {
            $this->cos10000id = $cos10000id;
        }
	...
	public function save() {
            $query = "INSERT INTO $this->table(id,documento,cos10000id,cantidad,activo)
                            VALUES(NULL,
                            '".$this->documento."',
                            '".$this->cos10000id."',
                            '".$this->cantidad."',
