...
class Cos10010 extends \EntidadBase {
	...
	public function __construct($adapter,$param=array(),$bd='') {
            ...
            {
                $this->table=$param['param1'].'.cos10010';
            }
            else if (strlen($bd)>0)
            {
                $this->table=$bd.'.cos10010';
            }
            else
            {
	...
	public function save() {
            $query = "INSERT INTO $this->table(id,documento,inv00000id,tasa,cantidad)
                            VALUES(NULL,
                            '".$this->documento."',
                            '".$this->inv00000id."',
                            '".$this->tasa."',
