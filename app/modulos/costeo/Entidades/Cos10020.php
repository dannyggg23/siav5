...
class Cos10020 extends \EntidadBase {
	...
	public function __construct($adapter,$param=array(),$bd='') {
            ...
            {
                $this->table=$param['param1'].'.cos10020';
            }
            else if (strlen($bd)>0)
            {
                $this->table=$bd.'.cos10020';
            }
            else
            {
                $this->table=isset($_SESSION['bdcliente'])?$_SESSION['bdcliente'].'.cos10020':'cos10020';
            }
	...
	public function save() {
            $query = "INSERT INTO $this->table(id,documento,inv00000id,cantidad)
                            VALUES(NULL,
                            '".$this->documento."',
                            '".$this->inv00000id."',
                            '".$this->cantidad."'
