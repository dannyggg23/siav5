...
class Cos40100 extends \EntidadBase {
	...
	public function __construct($adapter,$param=array(),$bd='') {
            ...
            {
                $this->table=$param['param1'].'.cos40100';
            }
            else if (strlen($bd)>0)
            {
                $this->table=$bd.'.cos40100';
            }
            else
            {
                $this->table=isset($_SESSION['bdcliente'])?$_SESSION['bdcliente'].'.cos40100':'cos40100';
            }
	...
	public function save() {
            $query = "INSERT INTO $this->table(id,tipo,prefijo,secuencia,activo)
                            VALUES(NULL,
                            '".$this->tipo."',
                            '".$this->prefijo."',
                            '".$this->secuencia."',
