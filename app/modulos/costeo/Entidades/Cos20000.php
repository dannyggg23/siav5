...
class Cos20000 extends \EntidadBase {
	...
	public function __construct($adapter,$param=array(),$bd='') {
            ...
            {
                $this->table=$param['param1'].'.cos20000';
            }
            else if (strlen($bd)>0)
            {
                $this->table=$bd.'.cos20000';
            }
            else
            {
                $this->table=isset($_SESSION['bdcliente'])?$_SESSION['bdcliente'].'.cos20000':'cos20000';
            }
	...
	public function save() {
            $query = "INSERT INTO $this->table(id,documento,documento_orden,descripcion,fecha,usuario,activo)
                            VALUES(NULL,
                            '".$this->documento."',
